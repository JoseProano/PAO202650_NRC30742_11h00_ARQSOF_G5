...
/**
 * Fragmento para conversiones de peso/masa
 * Permite convertir entre kilogramos, libras, gramos y onzas
 */
class PesoFragment : Fragment() {
    ...
    private fun setupUI() {
        // Configurar el spinner con las operaciones de peso
        val operaciones = controlador.getOperacionesPeso()
