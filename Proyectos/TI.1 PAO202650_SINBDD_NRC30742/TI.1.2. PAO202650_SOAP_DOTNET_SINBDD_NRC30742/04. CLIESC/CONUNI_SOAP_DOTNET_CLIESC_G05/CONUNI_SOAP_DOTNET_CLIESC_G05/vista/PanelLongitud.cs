...
namespace CONUNI_SOAP_DOTNET_CLIESC_G09.vista
{
    ...
    public class PanelLongitud : Panel
    {
        ...
        public PanelLongitud(ClienteConversionSoap cliente)
        {
            clienteSOAP = cliente;
            ...
            try
            {
                ...
                Task.Run(() =>
                {
                    ...
                    try
                    {
                        ...
                        {
                            case 0:
                                resultado = clienteSOAP.MetrosAPies(valor);
                                break;
                            case 1:
                                resultado = clienteSOAP.PiesAMetros(valor);
                                break;
                            case 2:
                                resultado = clienteSOAP.MetrosAPulgadas(valor);
                                break;
                            case 3:
                                resultado = clienteSOAP.PulgadasAMetros(valor);
                                break;
                            case 4:
                                resultado = clienteSOAP.KilometrosAMillas(valor);
                                break;
                            case 5:
                                resultado = clienteSOAP.MillasAKilometros(valor);
                                break;
                        }
