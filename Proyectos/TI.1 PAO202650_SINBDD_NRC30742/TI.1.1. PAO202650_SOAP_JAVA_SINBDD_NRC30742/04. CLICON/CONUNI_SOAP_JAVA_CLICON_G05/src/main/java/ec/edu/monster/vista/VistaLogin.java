...
public class VistaLogin {
    ...
    public void mostrarBannerLogin() {
        mostrarLogo();
       // mostrarImagenMonster();
        System.out.println("=".repeat(60));
        System.out.println(aplicarColor(CELESTE, "MONSTERS INC. CONVERTER - AUTENTICACIÓN"));
...
//    /**
//     * Muestra la imagen ASCII del monstruo
//     */
//    private void mostrarImagenMonster() {
//        System.out.println(aplicarColor(CELESTE, "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMMMMWNXXXWMMMMMMMMMMMMMMMMMMMMMMNXXNWWMMMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMMX0O0Ox0WMMMMMMMMWNXK0XMMMMMMMMXkxO00XWMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMW0dx0KOKWMMMWX000Okxdolk0O0NMMMMMNOxO0kONMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMM0clxOkkKNN0kdlclodddddooollxOOkOKXkldkkdkNMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMWd,;lodddoc:;:cloooddddooooooolllollodddoo0MMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMWO;.',;;;,;::::::ccodddoc:::::ccllllllcc:dXMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMWOc.....';;,,,,,,;cddo:,,,,;;;;:::;,',cxXMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMMNO:........','',cddoc;,',,'.',,;:;;dKWMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMMXx;',',,:odlccc:coddocccclddl;;:looxKWMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMNx,.,;;;:kXd'..ldooddoll'..cOXdldddlcoKWMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMXx;';;;;:xKk:',ldoooooooc',l0Kxodddoco0WMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMNOc,,;:ccccoxxddolcccccclddxkkdodddddolkXWMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMWXd,',;;coddolllc;,',;;;;;;;cloooddddddddccONMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMNx;,;;;:ldddddddo;'.',,,;;,;cdddddddddddxdcl0WM") + "\n" +
//                            aplicarColor(CELESTE, "MMMXl,,;;;codddddddddolc:::coddddddddddddddddockWM") + "\n" +
//                            aplicarColor(CELESTE, "MMWOc,;;;;cllloddddddddddddddddddddddolodddddddxXM") + "\n" +
//                            aplicarColor(CELESTE, "MMXo,,,;;;:loolokxdddddddddddddddodkdloddddddllo0W") + "\n" +
//                            aplicarColor(CELESTE, "MMXl'',,;;:ldddodolooloooooooooolloddddddddddl;cOW") + "\n" +
//                            aplicarColor(CELESTE, "MMNx:,;;;;;coddddoolllllooollloooddxdddddodddocl0M") + "\n" +
//                            aplicarColor(CELESTE, "MMMXo;;,,,;:codddddolllllllloooodddddddddoddoooOWM") + "\n" +
//                            aplicarColor(CELESTE, "MMMNd,',;;;;:lddddddddddddddddddddddddddddddlco0MM") + "\n" +
//                            aplicarColor(CELESTE, "MMMWO:,,;;;;;:cldddddddddddddddddddddddddddoc:dXMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMNKkc,',;;;;:clolcldddddddddooooollllool:dOXWMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMW0l;;,,,,;;;:;;:ccclllccc:::::;;::::lxXMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMMMWXOl;,',,,,,;;;;;;;;;;;;,,,;,',:lkXWMMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMMMMMMWKxllxd:;::;;;;;,,,::;:dOkoxKWMMMMMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMMMMMMMMMNNWWNKXKkl;;:ldOKXKNWMWWMMMMMMMMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMMMMMMMMMMMMMMMMMMN00KWMMMMMMMMMMMMMMMMMMMMMM") + "\n" +
//                            aplicarColor(CELESTE, "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM"));
//    }
    ...
    public void mostrarMensajeExito() {
        ...
        System.out.println(aplicarColor(VERDE, "Bienvenido al sistema Monsters Inc. Converter"));
        System.out.println("=".repeat(60));
        System.out.println();
    }
