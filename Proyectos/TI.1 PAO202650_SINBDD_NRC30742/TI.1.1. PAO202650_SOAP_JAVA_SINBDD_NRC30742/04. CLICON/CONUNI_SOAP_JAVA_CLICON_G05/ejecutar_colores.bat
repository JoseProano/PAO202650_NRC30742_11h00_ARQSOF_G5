@echo off
REM ============================================================
REM MONSTERS INC. CONVERTER - CLIENTE CONSOLA CON COLORES
REM Sistema de conversión de unidades con soporte UTF-8
REM ============================================================
...
REM Mostrar banner (usando echo simple con colores después)
echo.
echo ╔══════════════════════════════════════════════════════════════════════════════╗
echo ║                                                                              ║
echo ║                    MONSTERS INC. CONVERTER                                    ║
echo ║                  Sistema de Conversión de Unidades                              ║
echo ║                                                                              ║
echo ╚══════════════════════════════════════════════════════════════════════════════╝
echo.
...
set "JAR_FILE=target\CONUNI_SOAP_JAVA_CLICON_G09-1.0-SNAPSHOT.jar"
...
echo.
echo Nota: Asegúrese de que el servidor SOAP esté ejecutándose en:
echo http://localhost:8080/CONUNI_SOAP_JAVA_GR09/WSConversion
echo.
echo ══════════════════════════════════════════════════════════════════════════════
echo.
