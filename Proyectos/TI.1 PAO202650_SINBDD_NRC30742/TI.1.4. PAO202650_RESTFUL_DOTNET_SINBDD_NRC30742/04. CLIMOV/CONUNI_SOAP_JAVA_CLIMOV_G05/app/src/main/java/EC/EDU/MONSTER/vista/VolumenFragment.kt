...
/**
 * Fragmento para conversiones de volumen
 * Permite convertir entre litros, galones, mililitros y onzas fluidas
 */
class VolumenFragment : Fragment() {
    ...
    private fun setupUI() {
        // Configurar el spinner con las operaciones de volumen
        val operaciones = controlador.getOperacionesVolumen()
