...
class EurekaRestService(private val context: Context? = null) {
    companion object {
        ...
        private const val BASE_PATH = "/WSEurekaBank_Restfull_Java_G4/resources/corebancario"
    ...
    private fun parseMovimientosResponse(jsonResponse: String): List<Movimiento> {
        ...
        try {
            ...
            for (i in 0 until jsonArray.length()) {
                ...
                // Mapear campos del JSON del servidor a los campos del modelo Android
                // El servidor devuelve: cuenta, nromov, fecha, tipo, importe, referencia, accion
                ...
                movimiento.emplcodigo = "" // No viene en el JSON del servidor
                
                // Parsear fecha - el servidor devuelve "fecha" o "fechaAsString"
                val fechaStr = jsonObject.optString("fechaAsString", jsonObject.optString("fecha", ""))
