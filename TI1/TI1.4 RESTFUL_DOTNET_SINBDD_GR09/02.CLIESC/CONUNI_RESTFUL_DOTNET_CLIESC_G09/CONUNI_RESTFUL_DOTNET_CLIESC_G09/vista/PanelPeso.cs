...
namespace CONUNI_RESTFUL_DOTNET_CLIESC_G09.vista
{
    ...
    public class PanelPeso : Panel
    {
        ...
        public PanelPeso(ConversionApiClient cliente)
        {
            clienteREST = cliente;
        ...
        private void InicializarComponentes()
        {
            // Título
            lblTitulo = new Label();
            lblTitulo.Text = "CONVERSIONES DE PESO";
        ...
        private void ConfigurarEventos()
        {
            ...
            btnConvertir.MouseEnter += (s, e) => btnConvertir.BackColor = ROJO_MONSTER;
        ...
        private async void BtnConvertir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case 0:
                        resultado = await clienteREST.KilogramosALibrasAsync(valor);
                        break;
                    case 1:
                        resultado = await clienteREST.LibrasAKilogramosAsync(valor);
                        break;
                    case 2:
                        resultado = await clienteREST.GramosAOnzasAsync(valor);
                        break;
                    case 3:
                        resultado = await clienteREST.OnzasAGramosAsync(valor);
                        break;
                }
