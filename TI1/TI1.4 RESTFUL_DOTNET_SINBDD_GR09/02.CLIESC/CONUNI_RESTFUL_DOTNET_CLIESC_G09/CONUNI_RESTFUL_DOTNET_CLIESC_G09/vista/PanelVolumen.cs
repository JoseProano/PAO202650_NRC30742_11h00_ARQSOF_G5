...
namespace CONUNI_RESTFUL_DOTNET_CLIESC_G09.vista
{
    ...
    /// </summary>
    public class PanelVolumen : Panel
    {
        ...
        public PanelVolumen(ConversionApiClient cliente)
        {
            clienteREST = cliente;
        ...
        private void InicializarComponentes()
        {
            // Título
            lblTitulo = new Label();
            lblTitulo.Text = "CONVERSIONES DE VOLUMEN";
        ...
        private void ConfigurarEventos()
        {
            ...
            btnConvertir.MouseEnter += (s, e) => btnConvertir.BackColor = AMARILLO_MONSTER;
        ...
        private async void BtnConvertir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case 0:
                        resultado = await clienteREST.LitrosAGalonesAsync(valor);
                        break;
                    case 1:
                        resultado = await clienteREST.GalonesALitrosAsync(valor);
                        break;
                    case 2:
                        resultado = await clienteREST.MililitrosAOnzasFluidasAsync(valor);
                        break;
                    case 3:
                        resultado = await clienteREST.OnzasFluidasAMililitrosAsync(valor);
                        break;
                }
