...
namespace CONUNI_RESTFUL_DOTNET_CLIESC_G09.vista
{
    ...
    public class PanelTemperatura : Panel
    {
        ...
        public PanelTemperatura(ConversionApiClient cliente)
        {
            clienteREST = cliente;
        ...
        private async void BtnConvertir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case 0:
                        resultado = await clienteREST.CelsiusAFahrenheitAsync(valor);
                        break;
                    case 1:
                        resultado = await clienteREST.FahrenheitACelsiusAsync(valor);
                        break;
                    case 2:
                        resultado = await clienteREST.CelsiusAKelvinAsync(valor);
                        break;
                    case 3:
                        resultado = await clienteREST.KelvinACelsiusAsync(valor);
                        break;
                    case 4:
                        resultado = await clienteREST.FahrenheitAKelvinAsync(valor);
                        break;
                    case 5:
                        resultado = await clienteREST.KelvinAFahrenheitAsync(valor);
                        break;
                }
