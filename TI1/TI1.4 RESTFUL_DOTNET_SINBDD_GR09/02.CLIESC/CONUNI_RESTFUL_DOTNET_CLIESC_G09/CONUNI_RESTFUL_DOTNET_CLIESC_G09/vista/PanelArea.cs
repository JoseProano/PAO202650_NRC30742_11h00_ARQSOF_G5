...
namespace CONUNI_RESTFUL_DOTNET_CLIESC_G09.vista
{
    ...
    public class PanelArea : Panel
    {
        ...
        public PanelArea(ConversionApiClient cliente)
        {
            clienteREST = cliente;
        ...
        private async void BtnConvertir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case 0:
                        resultado = await clienteREST.MetrosCuadradosAPiesCuadradosAsync(valor);
                        break;
                    case 1:
                        resultado = await clienteREST.PiesCuadradosAMetrosCuadradosAsync(valor);
                        break;
                    case 2:
                        resultado = await clienteREST.HectareasAAcresAsync(valor);
                        break;
                    case 3:
                        resultado = await clienteREST.AcresAHectareasAsync(valor);
                        break;
                }
