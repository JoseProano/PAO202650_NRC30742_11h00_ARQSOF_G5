...
namespace CONUNI_SOAP_DOTNET_CLIESC_G09.vista
{
    ...
    public class PanelVolumen : Panel
    {
        ...
        public PanelVolumen(ClienteConversionSoap cliente)
        {
            clienteSOAP = cliente;
            ...
            try
            {
                ...
                Task.Run(() =>
                {
                    ...
                    try
                    {
                        ...
                        {
                            case 0:
                                resultado = clienteSOAP.LitrosAGalones(valor);
                                break;
                            case 1:
                                resultado = clienteSOAP.GalonesALitros(valor);
                                break;
                            case 2:
                                resultado = clienteSOAP.MililitrosAOnzasFluidas(valor);
                                break;
                            case 3:
                                resultado = clienteSOAP.OnzasFluidasAMililitros(valor);
                                break;
                        }
